...
export default function Index() {
  const { phase, streamedText, result, error, generate, reset } = useEchoes();
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] text-stone-800">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-16">
        ...
        >
          <h1 className="font-display text-5xl md:text-6xl font-normal tracking-tight text-stone-900 mb-3">
            Echoes
          </h1>
